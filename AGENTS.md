...
- Git repository initialized and pushed to GitHub:
  ...
  - default branch: `main`
- Package version is currently `0.6.1`.
...
- Chrome Manifest V3 extension:
  ...
  - extension manifest version is synchronized with package version `0.6.1`.
